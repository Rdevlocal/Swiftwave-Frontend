...
export default () => {
  ...
  const plans = [
    {
      name: "Starter",
      desc: "Perfect for individuals and small teams looking to explore AI products and basic automation tools.",
      price: "15",
    },
    {
      name: "Growth",
      desc: "Ideal for growing businesses needing more AI products and advanced automation features.",
      price: "50",
    },
    {
      name: "Professional",
      desc: "Best for established teams and enterprises leveraging multiple AI products with comprehensive automation.",
      price: "120",
    },
  ];
  ...
  const tables = [
    {
      ...
      items: [
        {
          name: "Access to AI Products",
          starter: checkIcon,
          growth: checkIcon,
          professional: checkIcon,
        },
        {
          name: "Advanced Automation Tools",
          starter: minusIcon,
          growth: checkIcon,
          professional: checkIcon,
        },
      ...
      <div className="">
        <div className="relative max-w-xl mx-auto space-y-3 px-4 sm:text-center md:px-0">
          ...
          <div className="max-w-xl">
            <p>
              Unlock the power of AI tailored to your needs. Choose a plan
              that grows with you.
            </p>
          </div>
        </div>
