    ...
    const plans = [
      {
        ...
        price: 100,  // Increased price
        isMostPop: false,
        features: [
          "Access to unlimited AI products",
          "Credits: $1 each",
      ...
      <section className='py-14 bg-black text-white'>
        <div className="max-w-screen-xl mx-auto px-4 md:px-8">
          ...
          <div className='mt-16 justify-center gap-6 sm:grid sm:grid-cols-2 sm:space-y-0 lg:grid-cols-3'>
            {
              plans.map((item, idx) => (
                <div key={idx} className={`relative flex-1 flex items-stretch flex-col rounded-xl border-2 mt-6 sm:mt-0 ${item.isMostPop ? "mt-10 border-indigo-600" : "border-gray-700"}`}>
                  {
                    item.isMostPop && (
