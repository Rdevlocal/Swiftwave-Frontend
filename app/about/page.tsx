            ...
            <section className="py-14">
                <div className="max-w-screen-xl mx-auto px-4 text-center text-gray-600 md:px-8">
                    <div className="max-w-2xl mx-auto">
                        <h3 className="text-white text-3xl font-semibold sm:text-4xl">Accelerate Your Product Launch</h3>
                        <p className="mt-3 text-white">
                            With our AI automation solutions, get your products to market faster, with fewer errors and more precision. Experience the future of automation.
                        </p>
                    </div>
                    <div className="mt-12">
                            ...
                            {[
                                {
                                    ...
                                    desc: "Leverage AI to develop and test prototypes in record time."
                                },
                                {
                                    icon: (
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                    ...
                                    title: "AI-Driven Global Scale",
                                    desc: "Connect and automate across multiple regions effortlessly."
                                },
                                {
                                    icon: (
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
