...
const AboutPage: React.FC = () => {
    ...
    return (
        <>
            {/* Section 1 */}
            <section style={{ backgroundColor: "#09090B" }} className="text-white">
                <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 md:px-8 xl:flex">
                    <div className="space-y-5 max-w-2xl mx-auto text-center xl:text-left">
                        <div className="flex flex-wrap items-center justify-center gap-6 xl:justify-start">
                            {features.map((item, idx) => (
                                <div key={idx} className="flex items-center gap-x-2 text-gray-400 text-sm">
                                    {item.icon}
                                    {item.name}
                                </div>
                            ))}
                        ...
                        <div className="items-center justify-center gap-x-3 space-y-3 sm:flex sm:space-y-0 xl:justify-start">
                            <a href="javascript:void(0)" className="flex items-center justify-center gap-x-2 py-2 px-4 text-gray-900 font-medium bg-white duration-150 hover:bg-gray-100 active:bg-gray-200 rounded-lg md:inline-flex">
                                Browse courses
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                                    <path fillRule="evenodd" d="M2 10a.75.75 0 01.75-.75h12.59l-2.1-1.95a.75.75 0 111.02-1.1l3.5 3.25a.75.75 0 010 1.1l-3.5 3.25a.75.75 0 11-1.02-1.1l2.1-1.95H2.75A.75.75 0 012 10z" clipRule="evenodd" />
                                </svg>
                            </a>
                            <a href="javascript:void(0)" className="flex items-center justify-center gap-x-2 py-2 px-4 text-gray-900 hover:text-gray-600 font-medium duration-150 active:bg-gray-100 bg-white border rounded-lg md:inline-flex">
                                Get access
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                                    <path fillRule="evenodd" d="M2 10a.75.75 0 01.75-.75h12.59l-2.1-1.95a.75.75 0 111.02-1.1l3.5 3.25a.75.75 0 010 1.1l-3.5 3.25a.75.75 0 11-1.02-1.1l2.1-1.95H2.75A.75.75 0 012 10z" clipRule="evenodd" />
                                </svg>
                    ...
                    <div className="flex-1 max-w-xl mx-auto mt-14 xl:mt-0">
                        <div className="relative">
                            ...
                            <button className="absolute w-16 h-16 rounded-full inset-0 m-auto duration-150 bg-gray-200 hover:bg-gray-300 ring-offset-2 focus:ring text-white" onClick={() => setVideoPopUp(true)}>
            ...
            <section className="py-14" style={{ background: "#09090B" }}>
                <div className="max-w-screen-xl mx-auto px-4 text-gray-300 gap-x-12 items-start justify-between lg:flex md:px-8">
                    ...
                    <div className="grid grid-cols-2 gap-6 lg:w-1/2 lg:grid-cols-1">
                        <div className="bg-gray-700 p-5 rounded-xl">
                            <h3 className="text-lg font-bold">Online courses</h3>
                            <p className="text-sm mt-1">Explore thousands of courses online.</p>
                        </div>
                        <div className="bg-gray-700 p-5 rounded-xl">
                            <h3 className="text-lg font-bold">Professional Certificates</h3>
                            <p className="text-sm mt-1">Get certified by top universities and companies.</p>
                        </div>
                        <div className="bg-gray-700 p-5 rounded-xl">
                            <h3 className="text-lg font-bold">Hands-on Projects</h3>
                            <p className="text-sm mt-1">Work on real-life projects and build your portfolio.</p>
                        </div>
                        <div className="bg-gray-700 p-5 rounded-xl">
                            <h3 className="text-lg font-bold">Community Support</h3>
                            <p className="text-sm mt-1">Join a community of learners and share knowledge.</p>
                        </div>
                    </div>
                </div>
            </section>
