export default () => {
    return (
        <>
            ...
            {/* Section 4 - Why Swiftwave? */}
            <section className="py-14">
                <div className="max-w-screen-xl mx-auto md:px-8">
                    <div className="items-center gap-x-12 sm:px-4 md:px-0 lg:flex">
                        <div className="max-w-xl px-4 space-y-3 mt-6 sm:px-0 md:mt-0 lg:max-w-2xl text-white">
                            <h3 className="text-3xl font-semibold sm:text-4xl">Why Swiftwave?</h3>
                            <p className="mt-3">
                                At Swiftwave, we specialize in delivering AI-powered automation that allows your business to adapt and scale in a fast-paced environment. Whether it's automating routine tasks or enhancing decision-making with AI, we help you achieve your goals faster and more efficiently.
                            </p>
            ...
            <section className="py-14">
                <div className="max-w-screen-xl mx-auto px-4 text-center md:px-8">
                    <h3 className="text-3xl font-semibold text-white">Partner with Swiftwave</h3>
                    <p className="mt-3 text-white">
                        Ready to revolutionize your business with AI? Get in touch with us and discover how Swiftwave's AI automation can take your operations to the next level.
                    </p>
